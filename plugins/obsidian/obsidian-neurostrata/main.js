...
function tw() {
  ...
  function f(g) {
    ...
    for (y = 0; y < T; y += 4)
      P = e[g.charCodeAt(y)] << 18 | e[g.charCodeAt(y + 1)] << 12 | e[g.charCodeAt(y + 2)] << 6 | e[g.charCodeAt(y + 3)], _[R++] = P >> 16 & 255, _[R++] = P >> 8 & 255, _[R++] = P & 255;
  ...
  function d(g, P, S) {
    for (var b, w = [], _ = P; _ < S; _ += 3)
      b = (g[_] << 16 & 16711680) + (g[_ + 1] << 8 & 65280) + (g[_ + 2] & 255), w.push(h(b));
    return w.join("");
  }
  function m(g) {
    for (var P, S = g.length, b = S % 3, w = [], _ = 16383, R = 0, T = S - b; R < T; R += _)
...
function Tf() {
  ...
  o.isBuffer = function(u) {
    ...
    for (E = 0; E < u.length; ++E) {
      let $ = u[E];
      if (Ze($, Uint8Array))
        q + $.length > C.length ? (o.isBuffer($) || ($ = o.from($)), $.copy(C, q)) : Uint8Array.prototype.set.call(C, $, q);
      else if (o.isBuffer($))
        $.copy(C, q);
      else
        throw new TypeError('"list" argument must be an Array of Buffers');
  ...
  o.prototype.swap16 = function() {
    ...
    if (l === void 0 && (l = 0), E === void 0 && (E = u ? u.length : 0), C === void 0 && (C = 0), q === void 0 && (q = this.length), l < 0 || E > u.length || C < 0 || q > this.length)
  ...
  function y(p, u, l, E, C) {
    ...
    if (typeof u == "number")
      return u = u & 255, typeof Uint8Array.prototype.indexOf == "function" ? C ? Uint8Array.prototype.indexOf.call(p, u, l) : Uint8Array.prototype.lastIndexOf.call(p, u, l) : O(p, [u], l, E, C);
  ...
  o.prototype.write = function(u, l, E, C) {
    if (l === void 0)
      C = "utf8", E = this.length, l = 0;
    else if (E === void 0 && typeof l == "string")
      C = l, E = this.length, l = 0;
    else if (isFinite(l))
      l = l >>> 0, isFinite(E) ? (E = E >>> 0, C === void 0 && (C = "utf8")) : (C = E, E = void 0);
    else
      throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");
    let q = this.length - l;
    if ((E === void 0 || E > q) && (E = q), u.length > 0 && (E < 0 || l < 0) || l > this.length)
  ...
  o.prototype.writeBigUInt64LE = at(function(u, l = 0) {
    ...
    for (this[l] = u & 255; ++q < E && ($ *= 256); )
      u < 0 && k === 0 && this[l + q - 1] !== 0 && (k = 1), this[l + q] = (u / $ >> 0) - k & 255;
    return l + E;
  ...
  o.prototype.writeDoubleLE = function(u, l, E) {
    ...
    if (E || (E = 0), !C && C !== 0 && (C = this.length), l >= u.length && (l = u.length), l || (l = 0), C > 0 && C < E && (C = E), C === E || u.length === 0 || this.length === 0)
      return 0;
    if (l < 0)
    ...
    if (typeof u == "string") {
      if (typeof l == "string" ? (C = l, l = 0, E = this.length) : typeof E == "string" && (C = E, E = this.length), C !== void 0 && typeof C != "string")
  ...
  function xn(p, u) {
    ...
    for (let $ = 0; $ < p.length && !((u -= 2) < 0); ++$)
      l = p.charCodeAt($), E = l >> 8, C = l % 256, q.push(C), q.push(E);
    return q;
  }
  function Ii(p) {
...
function yw() {
  ...
  s.prototype.getMaxListeners = function() {
    ...
    if (M) {
      var U;
      if (O.length > 0 && (U = O[0]), U instanceof Error)
        throw U;
  ...
  function f(T, y, O, v) {
    var M, F, U;
    if (a(O), F = T._events, F === void 0 ? (F = T._events = /* @__PURE__ */ Object.create(null), T._eventsCount = 0) : (F.newListener !== void 0 && (T.emit("newListener", y, O.listener ? O.listener : O), F = T._events), U = F[y]), U === void 0)
  ...
  s.prototype.once = function(y, O) {
    ...
    var v, M, F, U, Q;
    if (a(O), M = this._events, M === void 0)
      return this;
    if (v = M[y], v === void 0)
      return this;
    if (v === O || v.listener === O)
      --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete M[y], M.removeListener && this.emit("removeListener", y, v.listener || O));
    ...
    if (v.removeListener === void 0)
      return arguments.length === 0 ? (this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0) : v[y] !== void 0 && (--this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : delete v[y]), this;
    ...
    if (O = v[y], typeof O == "function")
      this.removeListener(y, O);
    else if (O !== void 0)
      for (M = O.length - 1; M >= 0; M--)
        this.removeListener(y, O[M]);
    return this;
  };
  function m(T, y, O) {
    var v = T._events;
...
var Xr = j((DO, zf) => {
  ...
  function sm(t, e = "signal") {
    if (ms(t, e), Df[t] === void 0)
      throw Df[jw(t)] !== void 0 ? new Uf(t + " (signals must use all capital letters)") : new Uf(t);
  }
  ...
  function dm(t, e, r) {
    if (!Ff(r, t))
      throw new je(e, `('${Wf(r, "|")}')`, t);
  }
  var pm = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
  function jf(t, e) {
    if (typeof t > "u" || !$f(pm, t))
  ...
  function Eh(t, e, r) {
    ...
    let s = (n = e.readable) !== null && n !== void 0 ? n : As(t), o = (i = e.writable) !== null && i !== void 0 ? i : wh(t), a = t._writableState, c = t._readableState, f = () => {
      ...
      if (y && typeof y != "boolean")
        return r.call(t, y);
      if (s && !g && As(t, true) && !yh(t, false))
        return r.call(t, new dh());
      if (o && !d && !mh(t, false))
        return r.call(t, new dh());
      r.call(t);
    }, _ = () => {
...
var kn = j((VR, Hi) => {
  ...
  var { SymbolDispose: h_ } = Ee(), { AbortError: Mh, codes: d_ } = De(), { isNodeStream: Nh, isWebStream: p_, kControllerErrorFunction: y_ } = mt(), g_ = Ut(), { ERR_INVALID_ARG_TYPE: qh } = d_, Bs, b_ = (t, e) => {
    if (typeof t != "object" || !("aborted" in t))
      throw new qh(e, "AbortSignal", t);
  };
  Hi.exports.addAbortSignal = function(e, r) {
    if (b_(e, "signal"), !Nh(r) && !p_(r))
      throw new qh("stream", ["ReadableStream", "WritableStream", "Stream"], r);
...
var Qh = j((Kh) => {
  ...
  function O_(t) {
    var e = P_(t);
    if (typeof e != "string" && (Ls.isEncoding === zh || !zh(t)))
...
var Nn = j((Jk, bd) => {
  ...
  le.prototype.read = function(t) {
    ...
    if (t > e.highWaterMark && (e.highWaterMark = Iv(t)), t !== 0 && (e.state &= ~ud), t === 0 && e.needReadable && ((e.highWaterMark !== 0 ? e.length >= e.highWaterMark : e.length > 0) || e.ended))
      return de("read: emitReadable", e.length, e.ended), e.length === 0 && e.ended ? Ws(this) : Ji(this), null;
    if (t = td(t, e), t === 0 && e.ended)
      return e.length === 0 && Ws(this), null;
    let n = (e.state & Ki) !== 0;
    if (de("need readable", n), (e.length === 0 || e.length - t < e.highWaterMark) && (n = true, de("length less than watermark", n)), e.ended || e.reading || e.destroyed || e.errored || !e.constructed)
      n = false, de("reading, ended or constructing", n);
    else if (n) {
...
var Hd = j((bC, $d) => {
  ...
  $d.exports = function t(e, r) {
    ...
    if (Bd(e))
      return an({ readable: Wd.fromWeb(e) });
    if (Md(e))
      return an({ writable: l0.fromWeb(e) });
    if (typeof e == "function") {
      let { value: i, write: s, final: o, destroy: a } = h0(e);
      if (Rd(i))
        return Ud(ir, i, { objectMode: true, write: s, final: o, destroy: a });
      let c = i == null ? void 0 : i.then;
      if (typeof c == "function") {
        let f, h = jd(c, i, (d) => {
          if (d != null)
            throw new qd("nully", "body", d);
        }, (d) => {
          un(f, d);
        });
    ...
    if (Rd(e))
      return Ud(ir, e, { objectMode: true, writable: false });
    if (Bd(e == null ? void 0 : e.readable) && Md(e == null ? void 0 : e.writable))
      return ir.fromWeb(e);
    ...
    return { value: t(async function* () {
      for (; ; ) {
        ...
        if (Zs.nextTick(f), c)
          return;
        if (i.aborted)
          throw new Fd(void 0, { cause: i.reason });
    ...
    for (let R = 0; R < t.length; R++) {
      ...
      if (R === 0)
        if (typeof T == "function") {
          ...
          Pr(T) || io(T) || cn(T) ? S = T : S = Xd.from(T);
        ...
        if (S = T(S, { signal: i }), y) {
          ...
          if (typeof U == "function")
            ...
            throw new ua("AsyncIterable or Promise", "destination", S);
          S = F;
        ...
        if (io(S)) {
          ...
          throw new ga("val", ["Readable", "Iterable", "AsyncIterable", "ReadableStream", "TransformStream"], S);
        S = T;
      } else if (C0(T)) {
        if (io(S))
          m++, ya(pa(S), T, g, { end: v });
...
var wa = j((dB, up) => {
  ...
  up.exports = function(...e) {
    ...
    for (let g = 0; g < e.length; ++g)
      if (!(!uo(e[g]) && !ba(e[g]))) {
        if (g < e.length - 1 && !(np(e[g]) || sp(e[g]) || Or(e[g])))
          throw new ap(`streams[${g}]`, r[g], "must be readable");
        if (g > 0 && !(ip(e[g]) || op(e[g]) || Or(e[g])))
          throw new ap(`streams[${g}]`, r[g], "must be writable");
      }
    let n, i, s, o, a;
    function c(g) {
      let P = o;
...
var $p = j((M2, Wp) => {
  ...
  var GS = Bp(), { EventEmitter: zS } = (er(), me(Zt)), Fp = Np(), pe = Pa(), ae = At()("mqtt-packet:parser"), Oa = class t extends zS {
    ...
    _parseConnect() {
      ...
      if (o.clean = (this._list.readUInt8(this._pos) & pe.CLEAN_SESSION_MASK) !== 0, this._pos++, o.keepalive = this._parseNum(), o.keepalive === -1)
        return this._emitError(new Error("Packet too short"));
    ...
    _parseConnack() {
      ...
      if (e.sessionPresent = !!(r & pe.SESSIONPRESENT_MASK), this.settings.protocolVersion === 5)
    ...
    _parseSubscribe() {
      ...
      if (e.subscriptions = [], !!this._parseMessageId()) {
        ...
        for (; this._pos < e.length; ) {
          ...
          if (a = (n >> pe.SUBSCRIBE_OPTIONS_NL_SHIFT & pe.SUBSCRIBE_OPTIONS_NL_MASK) !== 0, o = (n >> pe.SUBSCRIBE_OPTIONS_RAP_SHIFT & pe.SUBSCRIBE_OPTIONS_RAP_MASK) !== 0, s = n >> pe.SUBSCRIBE_OPTIONS_RH_SHIFT & pe.SUBSCRIBE_OPTIONS_RH_MASK, s > 2)
    ...
    _parseAuth() {
      ...
      if (e.reasonCode = this._parseByte(), !pe.MQTT5_AUTH_CODES[e.reasonCode])
...
var Ba = j((cN, ry) => {
  ...
  function aE(t, e, r) {
    ...
    if (g += 1, (typeof f == "string" || se.isBuffer(f)) && (f || s >= 4) && (f || a))
      g += se.byteLength(f) + 2;
    else {
      if (s < 4)
    ...
    if (o) {
      ...
      if (g += se.byteLength(o.topic) + 2, g += 2, o.payload)
        if (o.payload.length >= 0)
          typeof o.payload == "string" ? g += se.byteLength(o.payload) : g += o.payload.length;
        else
          return e.destroy(new Error("Invalid will payload")), false;
      if (S = {}, s === 5) {
        if (S = ar(e, o.properties), !S)
          return false;
        g += S.length;
      }
    }
  ...
  var Ma = class extends vE {
    ...
    concat() {
      ...
      for (s = 0; s < n.length && n[s] !== void 0; s++)
        typeof n[s] != "string" ? r[s] = n[s].length : r[s] = ny.byteLength(n[s]), e += r[s];
  ...
  function kE(t, e, r = false) {
    ...
    for (let i of n)
      for (let s of Object.getOwnPropertyNames(i.prototype))
        (r || s !== "constructor") && Object.defineProperty(t.prototype, s, (_a = Object.getOwnPropertyDescriptor(i.prototype, s)) != null ? _a : /* @__PURE__ */ Object.create(null));
  }
...
var Sy = j((_o) => {
  var _a, _b2, _u, _u2, _f2, _y2, _g2, _R, _k, _i2, _b3, _n, _r, _e, _l2, _h, _a2, _o2, _w2, _s, _m, __, _d, _v, _x2, _c2, _N, N_fn, _T, _I2, _q, _p, _F, F_fn, _P, _C, _L, _S, S_fn, _E, E_fn, _U, U_fn, _c3, _B, B_fn, _M, M_fn, _t, t_fn, _D, D_fn, _O, O_fn, _A, A_fn, _j, j_fn, _d2;
  "use strict";
  A();
  x();
  I();
  ...
  }, _u = new WeakMap(), __privateAdd(_b2, _u, false), _b2), Va = (_d2 = class {
    constructor(e) {
      ...
      if (!this.ttlAutopurge && !__privateGet(this, _u2) && !__privateGet(this, _f2)) {
        ...
        NE(M) && (my.add(M), _y("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", M, _d2));
      }
    }
    ...
    *rvalues() {
    ...
    set(e, r, n = {}) {
      ...
      if (d === void 0)
        ...
        if (r !== m) {
          if (__privateGet(this, _x2) && __privateMethod(this, _t, t_fn).call(this, m)) {
            m.__abortController.abort(new Error("replaced"));
            let { __staleWhileFetching: g } = m;
            g !== void 0 && !o && (__privateGet(this, _v) && ((_a3 = __privateGet(this, _y2)) == null ? void 0 : _a3.call(this, g, e, "set")), __privateGet(this, _c2) && ((_b4 = __privateGet(this, _s)) == null ? void 0 : _b4.push([g, e, "set"])));
          } else
            o || (__privateGet(this, _v) && ((_c4 = __privateGet(this, _y2)) == null ? void 0 : _c4.call(this, m, e, "set")), __privateGet(this, _c2) && ((_d3 = __privateGet(this, _s)) == null ? void 0 : _d3.push([m, e, "set"])));
          if (__privateGet(this, _P).call(this, d), __privateGet(this, _C).call(this, d, h, c), __privateGet(this, _e)[d] = r, c) {
            c.set = "replace";
            let g = m && __privateMethod(this, _t, t_fn).call(this, m) ? m.__staleWhileFetching : m;
      ...
      if (i !== 0 && !__privateGet(this, _d) && __privateMethod(this, _N, N_fn).call(this), __privateGet(this, _d) && (f || __privateGet(this, _q).call(this, d, i, s), c && __privateGet(this, _I2).call(this, c, d)), !o && __privateGet(this, _c2) && __privateGet(this, _s)) {
        ...
        for (; g = m == null ? void 0 : m.shift(); )
          (_e2 = __privateGet(this, _g2)) == null ? void 0 : _e2.call(this, ...g);
      }
      return this;
    }
    pop() {
      ...
      try {
        ...
        if (__privateGet(this, _c2) && __privateGet(this, _s)) {
          ...
          for (; r = e == null ? void 0 : e.shift(); )
            (_a3 = __privateGet(this, _g2)) == null ? void 0 : _a3.call(this, ...r);
        }
      }
    }
    has(e, r = {}) {
    ...
    async fetch(e, r = {}) {
      ...
      if (!__privateGet(this, _x2))
        return w && (w.fetch = "get"), this.get(e, { allowStale: n, updateAgeOnGet: i, noDeleteOnStaleGet: s, status: w });
      ...
      if (T === void 0) {
        w && (w.fetch = "miss");
        let y = __privateMethod(this, _M, M_fn).call(this, e, T, R, S);
        return y.__returned = y;
      } else {
        let y = __privateGet(this, _e)[T];
        if (__privateMethod(this, _t, t_fn).call(this, y)) {
        ...
        if (!b && !O)
          return w && (w.fetch = "hit"), __privateMethod(this, _O, O_fn).call(this, T), i && __privateGet(this, _T).call(this, T), w && __privateGet(this, _I2).call(this, w, T), y;
        let v = __privateMethod(this, _M, M_fn).call(this, e, T, R, S), F = v.__staleWhileFetching !== void 0 && n;
  ...
  }, _c3 = Symbol.toStringTag, _u2 = new WeakMap(), _f2 = new WeakMap(), _y2 = new WeakMap(), _g2 = new WeakMap(), _R = new WeakMap(), _k = new WeakMap(), _i2 = new WeakMap(), _b3 = new WeakMap(), _n = new WeakMap(), _r = new WeakMap(), _e = new WeakMap(), _l2 = new WeakMap(), _h = new WeakMap(), _a2 = new WeakMap(), _o2 = new WeakMap(), _w2 = new WeakMap(), _s = new WeakMap(), _m = new WeakMap(), __ = new WeakMap(), _d = new WeakMap(), _v = new WeakMap(), _x2 = new WeakMap(), _c2 = new WeakMap(), _N = new WeakSet(), N_fn = function() {
    ...
    let c = { signal: o.signal, options: n, context: i }, f = (S, b = false) => {
      ...
      if (n.status && (w && !b ? (n.status.fetchAborted = true, n.status.fetchError = o.signal.reason, _ && (n.status.fetchAbortIgnored = true)) : n.status.fetchResolved = true), w && !_ && !b)
        return d(o.signal.reason);
      let R = g;
      return __privateGet(this, _e)[r] === g && (S === void 0 ? R.__staleWhileFetching ? __privateGet(this, _e)[r] = R.__staleWhileFetching : __privateMethod(this, _A, A_fn).call(this, e, "fetch") : (n.status && (n.status.fetchUpdated = true), this.set(e, S, c.options))), S;
      ...
      if (__privateGet(this, _e)[r] === g && (!R || T.__staleWhileFetching === void 0 ? __privateMethod(this, _A, A_fn).call(this, e, "fetch") : w || (__privateGet(this, _e)[r] = T.__staleWhileFetching)), _)
    ...
    if (__privateGet(this, _c2) && ((_c4 = __privateGet(this, _s)) == null ? void 0 : _c4.length)) {
      ...
      for (; s = i == null ? void 0 : i.shift(); )
        (_d3 = __privateGet(this, _g2)) == null ? void 0 : _d3.call(this, ...s);
    }
    return n;
    ...
    if (__privateGet(this, _n).clear(), __privateGet(this, _e).fill(void 0), __privateGet(this, _r).fill(void 0), __privateGet(this, _d) && __privateGet(this, __) && (__privateGet(this, _d).fill(0), __privateGet(this, __).fill(0)), __privateGet(this, _m) && __privateGet(this, _m).fill(0), __privateSet(this, _a2, 0), __privateSet(this, _o2, 0), __privateGet(this, _w2).length = 0, __privateSet(this, _b3, 0), __privateSet(this, _i2, 0), __privateGet(this, _c2) && __privateGet(this, _s)) {
      ...
      for (; n = r == null ? void 0 : r.shift(); )
        (_c4 = __privateGet(this, _g2)) == null ? void 0 : _c4.call(this, ...n);
    }
  }, _d2);
  _o.LRUCache = Va;
});
...
var su = j((Bo) => {
  ...
  var Ry = Oy(), i1 = It(), ky = xt(), ou = class extends i1.Container {
            ...
            if (f !== this.h) {
              ...
              if (h === 0) {
                ...
                if (m === 0) {
                  ...
                  m < 0 && (i = new this.re(e, r), d.W === void 0 ? (d.W = i, i.tt = d) : (f.U = i, i.tt = f));
              }
            }
          }
          if (i === void 0)
    ...
    updateKeyByIterator(e, r) {
      let n = e.o;
      if (n === this.h && (0, ky.throwIteratorAccessError)(), this.i === 1)
        return n.u = r, true;
      if (n === this.h.U)
            ...
            try {
              if (F = 2, O) {
                if (v || (z = "next"), e = O[z]) {
                  ...
                  v === 1 && (e = O.return) && e.call(O), v < 2 && (M = TypeError("The iterator does not provide a '" + z + "' method"), v = 1);
                O = t;
...
var Sg = j((Vo, vg) => {
  ...
  (function(t, e) {
    ...
    var i = function(w) {
      ...
      return function(R) {
        return function(T) {
          for (var y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, O = arguments.length, v = new Array(O > 2 ? O - 2 : 0), M = 2; M < O; M++)
            v[M - 2] = arguments[M];
          var F = Symbol(), U = w(_);
          _.set(U, F);
          var Q = function() {
...
var zo = j((yt) => {
  ...
  var Fu = fr(sy()), $A = or(), kg = fr(cy()), HA = fr(At()), Cg = Ng(Na()), vn = fr(Ua()), VA = fr(Ky()), GA = fr(Iu()), zA = fr(Qy()), bi = Mr(), KA = Yy(), QA = fr(ju()), Bg = Ng(yi()), Wu = globalThis.setImmediate || ((...t) => {
    ...
    constructor(e, r) {
      ...
      this.options = r || {};
      for (let n in Mg)
        typeof this.options[n] > "u" ? this.options[n] = Mg[n] : this.options[n] = r[n];
    ...
    subscribe(e, r, n) {
      ...
      if (a !== null)
        return Wu(n, new Error(`Invalid topic ${a}`)), this;
      ...
      let m = (P, S) => {
        ...
        var _a2;
        let P = (_a2 = this.options.subscribeBatchSize) != null ? _a2 : h.length, S = [];
    ...
    unsubscribe(e, r, n) {
      ...
      if (i !== null)
        return Wu(n, new Error(`Invalid topic ${i}`)), this;
      if (this._checkDisconnecting(n))
        return this;
      let s = () => {
        let o = this._nextId();
    ...
    _storeAndSend(e, r, n) {
      ...
      let i = e, s;
      if (i.cmd === "publish" && (i = (0, kg.default)(e), s = this._removeTopicAliasAndRecoverTopicName(i), s))
        return r && r(s);
...
function JA() {
  ...
  let T = (H) => String.fromCodePoint(...H), y = function(H) {
    ...
    let ee = 0;
    for (H = J ? P(H / s) : H >> 1, H += P(H / z); H > g * n >> 1; ee += e)
      H = P(H / g);
...
function sI() {
  ...
  return nl = function(c) {
    ...
    }, g = r(0, f.length - h.length), P = [], S = 0; S < g; S++)
      P[S] = "$" + S;
...
function Wr() {
  ...
  return sl = function(V, te) {
    ...
    for (var ye = 1, Ae = true; ye < Y.length; ye += 1) {
      ...
      if ((_e === "constructor" || !Ae) && (he = true), X += "." + _e, Z = "%" + X + "%", v(_, Z))
        ne = _[Z];
      else if (ne != null) {
        if (!(_e in ne)) {
          if (!te)
...
function uI() {
  ...
  return ll = function(s, o, a) {
    ...
    if (t)
      t(s, o, { configurable: h === null && m ? m.configurable : !h, enumerable: c === null && m ? m.enumerable : !c, value: a, writable: f === null && m ? m.writable : !f });
    else if (d || !c && !f && !h)
      s[o] = a;
    else
      ...
      if (d === 47) {
        if (!(f === m - 1 || h === 1))
          if (f !== m - 1 && h === 2) {
            ...
            a.length > 0 ? a += "/" + s.slice(f + 1, m) : a = s.slice(f + 1, m), c = m - f - 1;
        f = m, h = 0;
      } else
        d === 46 && h !== -1 ? ++h : h = -1;
    }
    ...
    for (var m = a.length, g = m - d, P = h < g ? h : g, S = -1, b = 0; b <= P; ++b) {
      if (b === P) {
        if (g > P) {
          ...
          h > P && (o.charCodeAt(c + b) === 47 ? S = b : b === 0 && (S = 0));
        break;
      }
    ...
    if (a !== void 0 && a.length > 0 && a.length <= o.length) {
      ...
      for (d = o.length - 1; d >= 0; --d) {
        ...
        if (P === 47) {
          ...
          g === -1 && (h = false, g = d + 1), m >= 0 && (P === a.charCodeAt(m) ? --m === -1 && (f = d) : (m = -1, f = g));
      }
...
function Px() {
  ...
  Al = function k(B, re, ie, oe) {
    var fe = re || {};
    if (Re(fe, "quoteStyle") && fe.quoteStyle !== "single" && fe.quoteStyle !== "double")
      throw new TypeError('option "quoteStyle" must be "single" or "double"');
    if (Re(fe, "maxStringLength") && (typeof fe.maxStringLength == "number" ? fe.maxStringLength < 0 && fe.maxStringLength !== 1 / 0 : fe.maxStringLength !== null))
      throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
    var Qt = Re(fe, "customInspect") ? fe.customInspect : true;
    if (typeof Qt != "boolean" && Qt !== "symbol")
      throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
    if (Re(fe, "indent") && fe.indent !== null && fe.indent !== "	" && !(parseInt(fe.indent, 10) === fe.indent && fe.indent > 0))
    ...
    if (Xo(B)) {
      for (var Pn = "<" + y.call(String(B.nodeName)), ts = B.attributes || [], xi = 0; xi < ts.length; xi++)
    ...
    if (typeof globalThis < "u" && B === globalThis || typeof Il < "u" && B === Il)
...
` + B.prev;
  ...
  function $(k, B) {
    ...
    if (z) {
      Qt = {};
      for (var br = 0; br < fe.length; br++)
        Qt["$" + fe[br]] = fe[br];
    }
    for (var Ye in k)
      Re(k, Ye) && (re && String(Number(Ye)) === Ye && Ye < k.length || z && Qt["$" + Ye] instanceof Symbol || (O.call(/[^\w$]/, Ye) ? ie.push(B(Ye, k) + ": " + B(k[Ye], k)) : ie.push(Ye + ": " + B(k[Ye], k))));
    if (typeof W == "function")
      for (var Yt = 0; Yt < fe.length; Yt++)
        ee.call(k, fe[Yt]) && ie.push("[" + B(fe[Yt]) + "]: " + B(k[fe[Yt]], k));
    return ie;
  }
  return Al;
}
...
function Sb() {
  ...
  var t = Bl(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = function() {
    ...
    for (var R = _ && _.plainObjects ? /* @__PURE__ */ Object.create(null) : {}, T = 0; T < w.length; ++T)
    ...
    if (typeof _ != "object") {
      if (r(w))
        ...
        (R && (R.plainObjects || R.allowPrototypes) || !e.call(Object.prototype, _)) && (w[_] = true);
      else
        return [w, _];
      return w;
    }
    ...
    if (w.length === 0)
      return w;
    var O = w;
    if (typeof w == "symbol" ? O = Symbol.prototype.toString.call(w) : typeof w != "string" && (O = String(w)), R === "iso-8859-1")
    ...
    for (var _ = [{ obj: { o: w }, prop: "o" }], R = [], T = 0; T < _.length; ++T)
      for (var y = _[T], O = y.obj[y.prop], v = Object.keys(O), M = 0; M < v.length; ++M) {
        var F = v[M], U = O[F];
...
function Rx() {
  ...
  var t = Ox(), e = Sb(), r = Bl(), n = Object.prototype.hasOwnProperty, i = { brackets: function(b) {
    ...
    if (typeof F == "function" ? V = F(w, V) : V instanceof Date ? V = W(V) : _ === "comma" && s(V) && (V = e.maybeMap(V, function(Ne) {
      ...
      if (y)
        return M && !J ? M(w, h.encoder, ee, "key", H) : w;
      V = "";
    }
    if (d(V) || e.isBuffer(V)) {
      if (M) {
    ...
    var he;
    if (_ === "comma" && s(V))
      J && M && (V = e.maybeMap(V, M)), he = [{ value: V.length > 0 ? V.join(",") || null : void 0 }];
    else if (s(F))
      he = F;
    else {
    ...
    var y;
    if (b.arrayFormat in i ? y = b.arrayFormat : "indices" in b ? y = b.indices ? "indices" : "repeat" : y = h.arrayFormat, "commaRoundTrip" in b && typeof b.commaRoundTrip != "boolean")
  ...
  var t = Sb(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = { allowDots: false, allowEmptyArrays: false, allowPrototypes: false, allowSparse: false, arrayLimit: 20, charset: "utf-8", charsetSentinel: false, comma: false, decodeDotInKeys: false, decoder: t.decode, delimiter: "&", depth: 5, duplicates: "combine", ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictDepth: false, strictNullHandling: false }, i = function(m) {
    ...
    if (P.charsetSentinel)
      for (T = 0; T < _.length; ++T)
        _[T].indexOf("utf8=") === 0 && (_[T] === a ? y = "utf-8" : _[T] === o && (y = "iso-8859-1"), R = T, T = _.length);
    for (T = 0; T < _.length; ++T)
      if (T !== R) {
    ...
    for (var b = S ? g : s(g, P), w = m.length - 1; w >= 0; --w) {
      var _, R = m[w];
      if (R === "[]" && P.parseArrays)
        _ = P.allowEmptyArrays && (b === "" || P.strictNullHandling && b === null) ? [] : [].concat(b);
      else {
    ...
    if (g) {
      ...
      if (y) {
        if (!S.plainObjects && e.call(Object.prototype, y) && !S.allowPrototypes)
          return;
        O.push(y);
      }
      for (var v = 0; S.depth > 0 && (T = R.exec(w)) !== null && v < S.depth; ) {
        if (v += 1, !S.plainObjects && e.call(Object.prototype, T[1].slice(1, -1)) && !S.allowPrototypes)
          return;
        O.push(T[1]);
      }
      if (T) {
        if (S.strictDepth === true)
...
`, "	"], o = ["{", "}", "|", "\\", "^", "`"].concat(s), a = ["'"].concat(o), c = ["%", "/", "?", ";", "#"].concat(a), f = ["/", "?", "#"], h = 255, d = /^[+a-z0-9A-Z_-]{0,63}$/, m = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, g = { javascript: true, "javascript:": true }, P = { javascript: true, "javascript:": true }, S = { http: true, https: true, ftp: true, gopher: true, file: true, "http:": true, "https:": true, "ftp:": true, "gopher:": true, "file:": true }, b = Cx();
  function w(y, O, v) {
    if (y && typeof y == "object" && y instanceof e)
      return y;
    var M = new e();
  ...
  return e.prototype.resolveObject = function(y) {
    ...
    if (he && (v.hostname = "", v.port = null, v.host && (Z[0] === "" ? Z[0] = v.host : Z.unshift(v.host)), v.host = "", y.protocol && (y.hostname = null, y.port = null, y.host && (ne[0] === "" ? ne[0] = y.host : ne.unshift(y.host)), y.host = null), X = X && (ne[0] === "" || Z[0] === "")), Y)
      ...
      Z || (Z = []), Z.pop(), Z = Z.concat(ne), v.search = y.search, v.query = y.query;
    ...
    for (var ye = Z.slice(-1)[0], Ae = (v.host || y.host || Z.length > 1) && (ye === "." || ye === "..") || ye === "", _e = 0, ve = Z.length; ve >= 0; ve--)
...
var Qo = j((mi) => {
  ...
  function Rb(t, e) {
    ...
    for (let n = 0; n < t.length; n++)
      typeof t[n].chunk == "string" ? r[n] = Ob.Buffer.from(t[n].chunk, "utf8") : r[n] = t[n].chunk;
...
var Jl = j((ge) => {
  ...
  var Hb = ge && ge.__createBinding || (Object.create ? function(t, e, r, n) {
    ...
    for (var r in t)
      r !== "default" && !Object.prototype.hasOwnProperty.call(e, r) && Hb(e, t, r);
...
var NeuroStrataView = class extends import_obsidian.ItemView {
  ...
  async onOpen() {
    ...
    saveNewBtn.onclick = async () => {
      ...
      if (refFile) {
        ...
        if (refLines)
          payloadData.metadata.refs[0].lines = refLines;
      }
      try {
        if (this.plugin.mqtt) {
  ...
  renderFilteredMemories() {
    ...
    const filteredPoints = this.allCurrentPoints.filter((point) => {
      var _a;
      const textData = ((_a = point.payload) == null ? void 0 : _a.content) || "";
  ...
  renderMemoryCard(point) {
    ...
    let textData = ((_a = point.payload) == null ? void 0 : _a.content) || "";
    let refs = ((_c2 = (_b2 = point.payload) == null ? void 0 : _b2.metadata) == null ? void 0 : _c2.refs) || [];
    ...
    saveBtn.onclick = async () => {
      ...
      const newPayload = { content: newText, user_id: this.currentNamespace, metadata: {} };
...
var NeuroStrataSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("MQTT Broker URL (WebSocket)").setDesc("The WebSocket URL for the embedded NeuroStrata MQTT broker").addText((text) => text.setPlaceholder("ws://127.0.0.1:8081").setValue(this.plugin.settings.mqttUrl).onChange(async (value) => {
...
var NeuroStrataPlugin = class extends import_obsidian.Plugin {
  ...
  async generateCanvas(points, silent = false, targetFileName) {
    ...
    points.forEach((p) => {
      var _a, _b2;
      const refs = ((_b2 = (_a = p.payload) == null ? void 0 : _a.metadata) == null ? void 0 : _b2.refs) || [];
      let foundDoc = false;
      if (refs.length > 0) {
        refs.forEach((r) => {
          if (r.file) {
    ...
    Array.from(domainMap.keys()).forEach((docPath, colIndex) => {
      const x2 = startX + colIndex * (DOC_WIDTH + X_GAP);
      const y = startY;
      ...
      memories.forEach((mem, rowIndex) => {
        ...
        const memX = x2 + DOC_WIDTH + 100;
        const memY = y + rowIndex * (MEM_HEIGHT + 50);
        const rawText = ((_a = mem.payload) == null ? void 0 : _a.content) || "";
        nodes.push({
          id: memNodeId,
          type: "text",
          text: `**Memory [${((_b2 = mem.payload) == null ? void 0 : _b2.user_id) || "unknown"}]**
...
${((_b2 = mem.payload) == null ? void 0 : _b2.content) || ""}`,
